...
export class UsersService {
  ...
  async update(id: string, dto: { role?: string; active?: boolean }, actingUserId: string) {
    ...
    if (dto.role === 'admin' || dto.role === 'member' || dto.role === 'viewer') data.role = dto.role;
